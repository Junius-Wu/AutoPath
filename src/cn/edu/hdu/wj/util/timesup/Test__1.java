package cn.edu.hdu.wj.util.timesup;
...
import cn.edu.hdu.ckt.handle.DBM_elementToDBM;
...
import cn.edu.hdu.ckt.handle.StringToDBM_element;
import cn.edu.hdu.ckt.handle.StringToDBM_element__1;
...
public class Test__1 {
	public static void main(String[] args) {
		Automatic automatic=getAutomatic();//  获取测试用的自动机
		Automatic new_automatic=IPR__1.iPR(automatic);// IPR 状态拆分
		Automatic aTDRTAutomatic=ATDTR__1.aTDRT(new_automatic,automatic);// TDRT 去抽象时间迁移  
		//Automatic DFStree=StateCoverage__1.DFSTree(aTDRTAutomatic);
		ArrayList<Automatic> testCase=StateCoverage__1.testCase(aTDRTAutomatic);// 测试用例
